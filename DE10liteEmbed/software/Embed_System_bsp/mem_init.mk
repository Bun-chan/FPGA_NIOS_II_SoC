...
$(MEM_0)_START := 0x09200000
$(MEM_0)_END := 0x0935ffff
...
# Memory: onchip_ram
MEM_1 := Embed_onchip_ram
$(MEM_1)_NAME := onchip_ram
...
$(MEM_1)_START := 0x09404000
$(MEM_1)_END := 0x09407fff
$(MEM_1)_SPAN := 0x00004000
$(MEM_1)_HIERARCHICAL_PATH := onchip_ram
$(MEM_1)_WIDTH := 32
...
.PHONY: onchip_ram
onchip_ram: check_elf_exists $(MEM_INIT_DIR)/$(MEM_1).hex $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym
