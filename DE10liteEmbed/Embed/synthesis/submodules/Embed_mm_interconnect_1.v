...
`timescale 1 ps / 1 ps
module Embed_mm_interconnect_1 (
	...
	wire  [11:0] sysid_control_slave_agent_m0_address;                                             // sysid_control_slave_agent:m0_address -> sysid_control_slave_translator:uav_address
	...
	wire  [85:0] cmd_mux_001_src_data;                                                             // cmd_mux_001:src_data -> sysid_control_slave_agent:cp_data
	...
	wire  [11:0] led_pio_s1_agent_m0_address;                                                      // led_pio_s1_agent:m0_address -> led_pio_s1_translator:uav_address
	...
	wire         cmd_mux_002_src_valid;                                                            // cmd_mux_002:src_valid -> led_pio_s1_agent:cp_valid
	wire  [85:0] cmd_mux_002_src_data;                                                             // cmd_mux_002:src_data -> led_pio_s1_agent:cp_data
	wire         cmd_mux_002_src_ready;                                                            // led_pio_s1_agent:cp_ready -> cmd_mux_002:src_ready
	wire   [4:0] cmd_mux_002_src_channel;                                                          // cmd_mux_002:src_channel -> led_pio_s1_agent:cp_channel
	wire         cmd_mux_002_src_startofpacket;                                                    // cmd_mux_002:src_startofpacket -> led_pio_s1_agent:cp_startofpacket
	wire         cmd_mux_002_src_endofpacket;                                                      // cmd_mux_002:src_endofpacket -> led_pio_s1_agent:cp_endofpacket
	...
	wire  [11:0] slide_pio_s1_agent_m0_address;                                                    // slide_pio_s1_agent:m0_address -> slide_pio_s1_translator:uav_address
	...
	wire  [86:0] slide_pio_s1_agent_rf_source_data;                                                // slide_pio_s1_agent:rf_source_data -> slide_pio_s1_agent_rsp_fifo:in_data
	...
	wire  [86:0] slide_pio_s1_agent_rsp_fifo_out_data;                                             // slide_pio_s1_agent_rsp_fifo:out_data -> slide_pio_s1_agent:rf_sink_data
	...
	wire         cmd_mux_003_src_valid;                                                            // cmd_mux_003:src_valid -> slide_pio_s1_agent:cp_valid
	wire  [85:0] cmd_mux_003_src_data;                                                             // cmd_mux_003:src_data -> slide_pio_s1_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                            // slide_pio_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [4:0] cmd_mux_003_src_channel;                                                          // cmd_mux_003:src_channel -> slide_pio_s1_agent:cp_channel
	wire         cmd_mux_003_src_startofpacket;                                                    // cmd_mux_003:src_startofpacket -> slide_pio_s1_agent:cp_startofpacket
	wire         cmd_mux_003_src_endofpacket;                                                      // cmd_mux_003:src_endofpacket -> slide_pio_s1_agent:cp_endofpacket
	...
	wire  [86:0] timer_0_s1_agent_rf_source_data;                                                  // timer_0_s1_agent:rf_source_data -> timer_0_s1_agent_rsp_fifo:in_data
	...
	wire  [86:0] timer_0_s1_agent_rsp_fifo_out_data;                                               // timer_0_s1_agent_rsp_fifo:out_data -> timer_0_s1_agent:rf_sink_data
	...
	wire  [85:0] cmd_mux_004_src_data;                                                             // cmd_mux_004:src_data -> timer_0_s1_agent:cp_data
	...
	wire  [85:0] mm_clock_crossing_bridge_0_m0_agent_cp_data;                                      // mm_clock_crossing_bridge_0_m0_agent:cp_data -> router:sink_data
	...
	wire  [85:0] sysid_control_slave_agent_rp_data;                                                // sysid_control_slave_agent:rp_data -> router_002:sink_data
	...
	wire  [85:0] led_pio_s1_agent_rp_data;                                                         // led_pio_s1_agent:rp_data -> router_003:sink_data
	...
	wire         slide_pio_s1_agent_rp_valid;                                                      // slide_pio_s1_agent:rp_valid -> router_004:sink_valid
	wire  [85:0] slide_pio_s1_agent_rp_data;                                                       // slide_pio_s1_agent:rp_data -> router_004:sink_data
	wire         slide_pio_s1_agent_rp_ready;                                                      // router_004:sink_ready -> slide_pio_s1_agent:rp_ready
	wire         slide_pio_s1_agent_rp_startofpacket;                                              // slide_pio_s1_agent:rp_startofpacket -> router_004:sink_startofpacket
	wire         slide_pio_s1_agent_rp_endofpacket;                                                // slide_pio_s1_agent:rp_endofpacket -> router_004:sink_endofpacket
	...
	wire  [85:0] timer_0_s1_agent_rp_data;                                                         // timer_0_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [85:0] router_src_data;                                                                  // router:src_data -> mm_clock_crossing_bridge_0_m0_limiter:cmd_sink_data
	...
	wire  [85:0] mm_clock_crossing_bridge_0_m0_limiter_cmd_src_data;                               // mm_clock_crossing_bridge_0_m0_limiter:cmd_src_data -> cmd_demux:sink_data
	...
	wire  [85:0] rsp_mux_src_data;                                                                 // rsp_mux:src_data -> mm_clock_crossing_bridge_0_m0_limiter:rsp_sink_data
	...
	wire  [85:0] mm_clock_crossing_bridge_0_m0_limiter_rsp_src_data;                               // mm_clock_crossing_bridge_0_m0_limiter:rsp_src_data -> mm_clock_crossing_bridge_0_m0_agent:rp_data
	...
	wire         slide_pio_s1_agent_rdata_fifo_src_valid;                                          // slide_pio_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_003:in_0_valid
	wire  [33:0] slide_pio_s1_agent_rdata_fifo_src_data;                                           // slide_pio_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_003:in_0_data
	wire         slide_pio_s1_agent_rdata_fifo_src_ready;                                          // avalon_st_adapter_003:in_0_ready -> slide_pio_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_003_out_0_valid;                                                // avalon_st_adapter_003:out_0_valid -> slide_pio_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_003_out_0_data;                                                 // avalon_st_adapter_003:out_0_data -> slide_pio_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_003_out_0_ready;                                                // slide_pio_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_003:out_0_ready
	wire   [0:0] avalon_st_adapter_003_out_0_error;                                                // avalon_st_adapter_003:out_0_error -> slide_pio_s1_agent:rdata_fifo_sink_error
	...
	Embed_mm_interconnect_1_router router (
	...
	Embed_mm_interconnect_1_router_001 router_002 (
	...
	Embed_mm_interconnect_1_router_001 router_003 (
	...
	Embed_mm_interconnect_1_router_001 router_004 (
	...
	Embed_mm_interconnect_1_router_001 router_005 (
	...
	Embed_mm_interconnect_1_cmd_demux cmd_demux (
		.clk                (altpll_0_c2_clk),                                                 //        clk.clk
		.reset              (mm_clock_crossing_bridge_0_m0_reset_reset_bridge_in_reset_reset), //  clk_reset.reset
	...
	Embed_mm_interconnect_1_cmd_mux cmd_mux (
		.clk                 (altpll_0_c2_clk),                                                 //       clk.clk
		.reset               (mm_clock_crossing_bridge_0_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Embed_mm_interconnect_1_cmd_mux cmd_mux_001 (
		.clk                 (altpll_0_c2_clk),                                                 //       clk.clk
		.reset               (mm_clock_crossing_bridge_0_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Embed_mm_interconnect_1_cmd_mux cmd_mux_002 (
		.clk                 (altpll_0_c2_clk),                                                 //       clk.clk
		.reset               (mm_clock_crossing_bridge_0_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Embed_mm_interconnect_1_cmd_mux cmd_mux_003 (
		.clk                 (altpll_0_c2_clk),                                                 //       clk.clk
		.reset               (mm_clock_crossing_bridge_0_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Embed_mm_interconnect_1_cmd_mux cmd_mux_004 (
		.clk                 (altpll_0_c2_clk),                                                 //       clk.clk
		.reset               (mm_clock_crossing_bridge_0_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Embed_mm_interconnect_1_rsp_demux rsp_demux (
		.clk                (altpll_0_c2_clk),                                                 //       clk.clk
		.reset              (mm_clock_crossing_bridge_0_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Embed_mm_interconnect_1_rsp_demux rsp_demux_001 (
		.clk                (altpll_0_c2_clk),                                                 //       clk.clk
		.reset              (mm_clock_crossing_bridge_0_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Embed_mm_interconnect_1_rsp_demux rsp_demux_002 (
		.clk                (altpll_0_c2_clk),                                                 //       clk.clk
		.reset              (mm_clock_crossing_bridge_0_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Embed_mm_interconnect_1_rsp_demux rsp_demux_003 (
		.clk                (altpll_0_c2_clk),                                                 //       clk.clk
		.reset              (mm_clock_crossing_bridge_0_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Embed_mm_interconnect_1_rsp_demux rsp_demux_004 (
		.clk                (altpll_0_c2_clk),                                                 //       clk.clk
		.reset              (mm_clock_crossing_bridge_0_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Embed_mm_interconnect_1_rsp_mux rsp_mux (
		.clk                 (altpll_0_c2_clk),                                                 //       clk.clk
		.reset               (mm_clock_crossing_bridge_0_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Embed_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (altpll_0_c2_clk),                                                 // in_clk_0.clk
		.in_rst_0_reset (mm_clock_crossing_bridge_0_m0_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (slide_pio_s1_agent_rdata_fifo_src_data),                          //     in_0.data
		.in_0_valid     (slide_pio_s1_agent_rdata_fifo_src_valid),                         //         .valid
		.in_0_ready     (slide_pio_s1_agent_rdata_fifo_src_ready),                         //         .ready
